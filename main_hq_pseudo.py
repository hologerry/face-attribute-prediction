...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints_celebahq_module_pseudo', type=str, metavar='PATH',
                    help='path to save checkpoint (default: checkpoints)')
parser.add_argument('--resume', default='checkpoints_celebahq_module_pseudo/model_best.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    train_dataset = ImageAttributePseudoLMDB(
        args.data,
        'celebahq_ffhq_fake_all_pseudo_01',
        'train',
        transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        ImageAttributePseudoLMDB(args.data, 'celebahq_ffhq_fake_all_pseudo_01', 'attr_test', transforms.Compose([
            transforms.Resize((256, 256)),
            transforms.ToTensor(),
            normalize,
        ])),
