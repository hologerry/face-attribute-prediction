...
from celebahq_ffhq_pseudo import CelebAHQFFHQPseudo
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='checkpoints_celebahq_select_pseudo_03_module', type=str, metavar='PATH',
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, data in enumerate(train_loader):
        ...
        loss = []
        prec1 = []
        assert len(output) == len(args.selected_attrs)
